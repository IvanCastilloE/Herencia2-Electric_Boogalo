...
namespace Herencia2
{
    class Persona
    {
        ...
        public override string ToString() //Override nos ayuda a sobreeescribir la clase ToString para personalizar la funcion y modifica el comportamiento de ToString()
        {
